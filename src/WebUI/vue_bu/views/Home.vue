<template>
  ...
  <ul>
    ...
    <li>
      ...
      need to run <code>ng serve</code>. It runs in the background
    ...
    <li>
      ...
      <code>ng build</code> to produce minified, ahead-of-time compiled
      JavaScript files.
    </li>
  </ul>
  <p>
    The <code>ClientApp</code> subdirectory is a standard Angular CLI
    application. If you open a command prompt in that directory, you can run any
